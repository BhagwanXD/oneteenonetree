...
async function getPledges() {
  // ✅ pass the cookies FUNCTION, do NOT await or wrap it
...
export default async function Home() {
  ...
  <div className="flex items-center justify-center gap-3 md:gap-4 flex-wrap">
    ...
    <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-center">
      One Teen = One Tree <span className="text-[var(--acc)]">🌱</span>
    </h1>
  </div>
</Reveal>
          </Reveal>
        ...
        <div className="container">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-white/70 mt-3">
              <b>One Teen One Tree</b> has partnered with <b>Campus Unmuted</b> to
...
<section className="py-16">
  <div className="container">
    ...
    <p className="text-white/70 text-lg text-center mt-3">
      One Teen, One Tree advances global goals through youth-led, local action.
    </p>
