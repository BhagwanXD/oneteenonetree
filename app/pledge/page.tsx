...
export default async function PledgePage() {
  ...
  return (
    <PageShell
      header={
        <PageHeader
          title="Take the OneTeenOneTree Pledge"
          description="Commit to planting at least one tree and inspire others to take real climate action."
        ...
        <>
          <section className="text-center space-y-4">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <SignInButton className="btn">Sign in to take the pledge</SignInButton>
          ...
          <section>
            <div className="card max-w-3xl mx-auto">
              <h2 className="text-2xl font-semibold text-white">After you sign in</h2>
          ...
          <section>
            <div className="card text-center max-w-2xl mx-auto space-y-4">
              ...
              <SignInButton className="btn justify-center">Continue with Google</SignInButton>
          ...
          {!profile?.name ? (
            ...
            <div className="mx-auto max-w-2xl">
              <div className="card text-center space-y-4">
                <h2 className="text-2xl font-semibold text-white">You already pledged</h2>
...
function StatTile({
  ...
  return (
    <div className="card text-center space-y-2">
      ...
      <div className={`text-lg font-semibold ${muted ? 'text-white/70' : 'text-white'}`}>
        {value}
      </div>
    </div>
  )
